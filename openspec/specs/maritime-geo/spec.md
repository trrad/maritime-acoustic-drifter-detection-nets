...
Geographic coordinate conversion (lat/lon ↔ ENU meters) and coastline data loading (OSM land polygons, bbox clipping, point-in-polygon land exclusion) as the shared foundation for maritime simulation modules.
