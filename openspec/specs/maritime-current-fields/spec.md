...
Provides an ocean current field abstraction (CurrentField protocol) and a synthetic analytical implementation (SyntheticEddyField: mean flow + Gaussian eddies + M2 tide) for maritime node dynamics propagation and particle filter prediction.
