...
Truth-access schema module for validation tooling and the dashboard.
Physically separate from scenario_schema so PF code cannot import it
without tripping the import-linter contract registered by maritime-pf-float.
